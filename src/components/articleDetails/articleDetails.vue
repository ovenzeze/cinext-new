<template>
  <el-container>
    <div class="main">
      <div class="article">
        <img class="article-image" src="https://cs.vmovier.com/Uploads/Banner/2018/04/09/5acb77528ada5.jpg@1920w" alt="">
    ...
    <div class="aside">
      <div class="info-container">
        ...
        <img  class="author-avator" src="https://sfault-avatar.b0.upaiyun.com/236/471/2364719857-5b1509b01f946_big64" alt="">
          <br>
      ...
      <div class="recom-container">
        ...
        <div class="recom-item">
          <img  class="recom-cover" src="https://cs.vmovier.com/Uploads/Banner/2018/04/09/5acb77528ada5.jpg@1920w" alt="">
          <div class="recom-info-container">
            <p class="info-text">这是推荐标题，最多一行，8字</p>
          </div>
        </div>
        <div class="recom-item">
          <img  class="recom-cover" src="https://cs.vmovier.com/Uploads/Banner/2018/04/09/5acb77528ada5.jpg@1920w" alt="">
          <div class="recom-info-container">
            <span class="info-text">这是推荐标题，最多一行，8字,这是推荐标题，最多一行，8字</span>
          </div>
        </div>
        <div class="recom-item">
          <img  class="recom-cover" src="https://cs.vmovier.com/Uploads/Banner/2018/04/09/5acb77528ada5.jpg@1920w" alt="">
          <div class="recom-info-container">
            <span class="info-text">这是推荐标题，最多一行，8字</span>
          </div>
        </div>
        <div class="recom-item">
          <img  class="recom-cover" src="https://cs.vmovier.com/Uploads/Banner/2018/04/09/5acb77528ada5.jpg@1920w" alt="">
